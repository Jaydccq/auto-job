...
Bridge batch run `ud2ZjHmHaezabg_4LlWdk` requests a full A-G evaluation for Procore Technologies' `Software Engineer I (Datagrid)` role using the cached JD file at `/var/folders/ly/sdg_pj9x6xb8b89q5yytyhdw0000gn/T/auto-job-bridge-jd-ud2ZjHmHaezabg_4LlWdk.txt`.
