...
if (existsSync(join(repoRoot, "packages/auto-signup/package.json"))) {
  runNpmStep("auto-signup typecheck", join(repoRoot, "packages/auto-signup"), ["run", "typecheck"]);
  runNpmStep("auto-signup tests", join(repoRoot, "packages/auto-signup"), ["run", "test"]);
}
