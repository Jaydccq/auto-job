...
# auto-job batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
auto-job batch runner — process job offers in batch via claude -p workers
